  ...
  <div className="row g-0">
    ...
    <div className="col-md-8">
      <div className="card-body">
        ...
        y análisis de datos con Python. Tengo experiencia certificada en Documentación técnica Aeronáutica de helicópteros MI-171V, hice los
        electivos de carrera de Gestión de mantenimiento, análisis de Estructuras por el método de elementos finitos,
        Dinámica de fluidos computacionales y formulación - evaluación de proyectos. Puede escribirme directamente a WhatsApp, más abajo encontrará 3 simulaciones y cálculos agradables con Ansys 2022.</p>
...
<ul className="nav nav-tabs" id="myTab" role="tablist">
        ...
        <div className="card-body">
            <h5 className="card-title">Relajate un poco con los ángulos de Euler</h5>
            <p className="card-text">Puedes perdir que agregue el avión que tu quieras! :3</p>
            <a href="https://brunodv.github.io/AngulosEuler/"
        class="btn btn-success">Clic aquí para ingresar</a>
        </div>
        </div>
        </div>
